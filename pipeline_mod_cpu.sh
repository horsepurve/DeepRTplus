function do1round()
{
    ...
    cd ..
    python capsule_network_emb_cpu.py # using CPU version
    cd work
}
...
function ensemble1sed
{
    ...
    # $9 -> minrt, ${10} -> maxrt
    # using CPU version:
    python ensemble_emb_cpu.py $9 $round1dir $conv1 $round2dir $conv2 $round3dir $conv3 $result ${10} > "work/"${1}"_notrans_"${2}"_ensemble.log"
    cd work
}
...
ensemble1sed "mod" 2 '1' 8 '2' 10 '3' 12 0 110
echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 313 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 23 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 59 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 97 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 137 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 179 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 227 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 269 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
...
# echo "ensemble 3 rounds, 5 epochs each"
# ensemble1sed "mod" 367 '1' 8 '2' 10 '3' 12 0 110
# echo -e "done\n"
