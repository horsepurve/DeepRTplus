...
echo "job no.1/10"
do1round "Xbridge" 42 1 8 8 "../config.py"
do1round "Xbridge " 42 2 10 10 "../config.py"
do1round "Xbridge" 42 3 12 12 "../config.py"
echo "ensemble 3 rounds, 5 epochs each"
ensemble1sed "Xbridge" 42 '1' 8 '2' 10 '3' 12 9 46 
echo -e "done\n"
